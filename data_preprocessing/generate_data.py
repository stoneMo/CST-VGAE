...
parser.add_argument("--predict_frames", type=str, default='30', help="forecasted frames")
parser.add_argument("--landmark_path", type=str, default='./data/landmarks_all.pkl', help="path to landmarks file")
parser.add_argument("--gaze_path", type=str, default='./data/gaze_all.pkl', help='path to gaze file')
parser.add_argument("--YawPR_path", type=str, default='./data/YPR_all.pkl', help='path to YawPR file')
    ...
    for j in range(data_frames): 
        ...
        for id in index_arr:
            ...
            if gaze_prior and len(image_list) == data_frames\
                and len(gaze_list) == predict_frames\
                ...
                data_YPR = [np.concatenate((YawPR_dict[id][:2], YawPR_dict[id][:2,:2]), axis=-1) for id in gaze_list]   #[(2, 21), (2, 21), (2, 21), (2, 19), (2, 19)]
                ...
                data_YP = [np.concatenate((land_21, YawP), axis=0) for land_21, YawP in zip(data_21, data_YPR)]    #[(4, 21), (4, 21), (4, 21), (4, 21), (4, 21)]
                #print(data_YP[0])
...
if gaze_prior:
    ...
    np.save('./data/data_GAZE_prior/data_GAZE_'+args.predict_frames+'/train_data_gaze_'+str(gaze_before)+'.npy', train_data_list)
    np.save('./data/data_GAZE_prior/data_GAZE_'+args.predict_frames+'/train_label_gaze_'+str(gaze_before)+'.npy', train_label_list)
